...
## Table FORET
- <u>id_foret</u> : identifiant unique de la foret, un INT
...
## Table EAU
- <u>id_eau</u> : identifiant unique d'un cours d'eau, un INT
- nom : nom du cours d'eau, un TEXT
- type : type de cours d'eau, un TEXT

## Table ESPECE
- <u>id_espece</u> : identifiant unique d'une espece, un INT
...
## Table RISQUE
- <u>id_risque</u> : identifiant unique d'un risque, un INT
